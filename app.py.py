# -*- coding: utf-8 -*-
"""Copy 1_of Group13_SportsPrediction.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1mpDh8YMXurlHxWbOMHf87viA0-mf8tBy
"""
...
df = df.drop(['sofifa_id', 'player_url', 'player_face_url', 'real_face', 'club_logo_url','club_flag_url','nation_logo_url','nation_flag_url','dob','club_contract_valid_until',
                   'club_joined','club_jersey_number','nationality_id','club_loaned_from','nation_jersey_number','real_face','club_team_id','nation_team_id',
],axis=1)
...
columns_to_encode_together = ['player_positions', 'club_position', 'nation_position', 'preferred_foot', 'work_rate', 'body_type', 'player_tags', 'player_traits']
...
"""FEATURE SUBSETS CREATION TRY 1"""
...
params = {"learning_rate": [0.01], "max_depth": [10], "min_child_weight": [5]}
...
param_grid_gbr = {'n_estimators': [10], 'learning_rate': [0.01]}
...
#joblib.dump(gbr, '/content/drive/My Drive/Colab Notebooks/Group13_SportsPrediction.joblib')
#model = joblib.load('/content/drive/My Drive/Colab Notebooks/Group13_SportsPrediction.joblib')
